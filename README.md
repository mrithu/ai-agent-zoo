# ai-agent-zoo
Basic implementation and deployment of a client agent service using Agent Development Kit (ADK) to build an AI agent that uses tools.
Built a zoo agent that answers questions about animals using Wikipedia as part of the Gen AI APAC Academy Cohort - 1
...
## Output
The final chat window will look something like this
![op 1](https://github.com/mrithu/ai-agent-zoo/blob/main/img/mrithula_track1_workshop1.png?raw=true)
![op 2](https://github.com/mrithu/ai-agent-zoo/blob/main/img/mrithula_track1_workshop2.png?raw=true)
